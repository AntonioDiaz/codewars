...
class RainfallTest {
    //......................................................
    @Test
    fun testGetCityTemperaturesDoubles() {
        val cityTemperaturesDouble = cityTemperatures("Leganes", data)
        val temperaturesExpected = Arrays.asList(1.2, 0.9)
        assertEquals(temperaturesExpected, cityTemperaturesDouble)
    }

    @Test
    fun testGetCityTemperaturesSum() {
        assertFuzzyEquals(2.1, cityTemperatures("Leganes", data).sum())
    }
    ...
    @Test
    fun testMeanUnexistCity() {
        assertFuzzyEquals(mean("Lon", RainfallTest.data), -1.0)
    }

    @Test
    fun testVarianceUnexistCity() {
        assertFuzzyEquals(variance("Fuenlabrada", RainfallTest.data), -1.0)
    }

    companion object {
        var parisTemperaturesStr = "Jan 182.3,Feb 120.6,Mar 158.1,Apr 204.9,May 323.1,Jun 300.5,Jul 236.8,Aug 192.9,Sep 66.3,Oct 63.3,Nov 83.2,Dec 154.7"
        var simpleTemperaturesStr = "Jan 182.3,Feb 120.6"
